...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"#FF9200");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#00CCFF");//Height update
                div_update(divs[j],div_sizes[j],"#00CCFF");//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#FF0002");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#FF0002");//Height update
    div_update(divs[i-1],div_sizes[i-1],"#FF0002");//Height update

    for(var t=start;t<=i;t++)
    {
        div_update(divs[t],div_sizes[t],"#b1d925");//Color update
    }
